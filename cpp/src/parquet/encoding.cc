...
//TODO find a way to integrate this neatly into arrow and its build system
#if defined(_MSC_VER)
...
namespace fastdelta { // (added by Anieway to avoid unwanted effects/namespace clutter)
...
/**
 * lemire/FastDifferentialCoding (only supports 32bit) version of put 
*/
template <>
